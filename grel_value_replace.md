...
|	Replace one character with nothing, i.e. remove a character |		Edit cells -> Transform	|	value.replace("x ", "") |		value.replace(" ", "")     value.replace("-", "") |  Use this to remove a space, or a hyphen, or ... |	
